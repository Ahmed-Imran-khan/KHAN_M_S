  ...
  return (
    <div className="pt-5">
      ...
      <div className="d-flex justify-content-center pb-5">
        <div
          class="input-group mb-3 w-50 shadow"
          style={{
            borderRadius: "10px",
          }}
        >
      ...
      {/* CARDS */}
      <div className="w-100 row row-cols-1 row-cols-sm-2 row-cols-md-6 justify-content-center">
        {/* card1 */}
        <div class="product col card p-0 m-3 shadow">
          <img
            height="160"
            src="https://dvago-assets.s3.ap-southeast-1.amazonaws.com/dvago-products-images/panadol-500mg-tablets.webp"
            class="card-img-top"
            alt="..."
          />
          <div class="card-body">
          ...
          <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item">
              <button
                className="botton btn btn-success m-1 px-3"
                onClick={() => {
                  dispatch({
                    ...
                    payload: {
                      heading: "Panadol tab",
                      image:
                        "https://dvago-assets.s3.ap-southeast-1.amazonaws.com/dvago-products-images/panadol-500mg-tablets.webp",
                      price: 35,
                      description: "10 Tabs/1 Strip",
                    },
                  });
                  notify(); // This will call the notify function
                }}
              >
                Add
              </button>
        ...
        <div class="product col card p-0 m-3 shadow">
          <img
            height="160"
            src="https://smarthealer.pk/wp-content/uploads/2024/09/panadol-extra.webp"
            class="card-img-top"
            alt="..."
          />
          <div class="card-body">
                ...
                onClick={() => {
                  dispatch({
                    ...
                    payload: {
                      ...
                      image:
                        "https://smarthealer.pk/wp-content/uploads/2024/09/panadol-extra.webp",
                      price: 40,
                      description: "10 Tabs/1 Strip",
        ...
        <div class="product col card p-0 m-3 shadow">
          <img
            height="160"
            src="https://imchospital.com.pk/storage/assets/images/medicines/1631615826panadol-cf-2.jpg"
            class="card-img-top"
            alt="..."
          />
          <div class="card-body">
                ...
                onClick={() => {
                  dispatch({
                    ...
                    payload: {
                      ...
                      image:
                        "https://imchospital.com.pk/storage/assets/images/medicines/1631615826panadol-cf-2.jpg",
                      price: 41,
                      description: "10 Tabs/1 Strip",
                    },
                  });
        ...
        <div class="product col card p-0 m-3 shadow">
          <img
            height="160"
            src="https://dvago-assets.s3.ap-southeast-1.amazonaws.com/ProductsImages/Panadol%20Extend%20600x600.jpg"
            class="card-img-top"
            alt="..."
          />
          <div class="card-body">
                ...
                onClick={() => {
                  dispatch({
                    ...
                    payload: {
                      ...
                      image:
                        "https://dvago-assets.s3.ap-southeast-1.amazonaws.com/ProductsImages/Panadol%20Extend%20600x600.jpg",
                      price: 70,
                      description: "10 Tabs/1 Strip",
                    }, // Pass the heading name as payload
                  });
        ...
        <div class="product col card p-0 m-3 shadow">
          <img
            height="160"
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRNDudST2j_4B4M1ZB41RsqR6RWW7Twr9PUcw&s"
            class="card-img-top"
            alt="..."
          />
          <div class="card-body">
                ...
                onClick={() => {
                  dispatch({
                    ...
                    payload: {
                      ...
                      image:
                        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRNDudST2j_4B4M1ZB41RsqR6RWW7Twr9PUcw&s",
                      price: 100,
                      description: "1 pack",
                    }, // Pass the heading name as payload
                  });
        ...
        <div class="product col card p-0 m-3 shadow">
          <img
            height="160"
            src="https://www.dvago.pk/_next/image?url=https%3A%2F%2Fdvago-assets.s3.ap-southeast-1.amazonaws.com%2FProductsImages%2F16849-1.jpg&w=1920&q=50"
            class="card-img-top"
            alt="..."
          />
          <div class="card-body">
                ...
                onClick={() => {
                  dispatch({
                    ...
                    payload: {
                      ...
                      image:
                        "https://www.dvago.pk/_next/image?url=https%3A%2F%2Fdvago-assets.s3.ap-southeast-1.amazonaws.com%2FProductsImages%2F16849-1.jpg&w=1920&q=50",
                      price: 75,
                      description: "1 pack",
                    }, // Pass the heading name as payload
                  });
